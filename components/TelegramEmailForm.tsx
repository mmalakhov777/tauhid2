...
export const TelegramEmailForm = ({ telegramUser, onComplete, onSkip }: TelegramEmailFormProps) => {
  ...
  const modalContent = (
    <>
      {/* Backdrop with blur - Higher z-index than profile modal */}
      <div 
      ...
      <div className="fixed inset-0 z-[99999] flex items-center justify-center p-4 pointer-events-none">
        ...
        >
          <div className="bg-white dark:bg-zinc-900 rounded-3xl w-full h-[95vh] sm:h-auto sm:max-h-[90vh] sm:rounded-2xl flex flex-col overflow-hidden shadow-2xl">
            {/* Header Section */}
  ...
  // Render modal at document body level using portal - same as profile modal
