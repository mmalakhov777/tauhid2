...
export function PureMessageActions({
  ...
  const handleShare = async () => {
    ...
    if (webApp) {
      // For Telegram users, use Telegram's share functionality with the message content
      try {
        // Use Telegram's share URL scheme with the actual message content
        const shareText = textFromParts;
      ...
      // For non-Telegram users, copy the message content to clipboard
      try {
